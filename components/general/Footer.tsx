...
const Footer = () => {
    ...
    return (
        <footer className='py-4 px-6 md:px-12 lg:px-20 bg-blue-950 dark:bg-black md:py-8'>
            <div className="max-w-7xl mx-auto py-6 md:py-8 lg:py-12 border-y border-gray-800 text-center">
                            ...
                            <div className="flex flex-col items-start gap-4" key={index}>
                                {
                                    item.map((link, linkIndex) => (
                                        <a 
                                            key={linkIndex}
                                            href={link.href} 
                                            className={`text-sm text-gray-300 hover:text-white mx-2 ${linkIndex < item.length - 1 ? 'mr-4' : ''}`}
                                        >
                                            {link.name}
                                        </a>
                                    ))
